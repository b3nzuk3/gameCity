...
const Hero = () => {
  return (
    <div className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute w-64 h-64 bg-emerald-500/10 rounded-full filter blur-3xl top-1/3 -left-32 animate-pulse" style={{ animationDelay: "1s", animationDuration: "8s" }}></div>
      ...
      <div className="container mx-auto px-4 relative z-10 pt-24">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-block mb-6 px-3 py-1 rounded-full bg-emerald-900/50 backdrop-blur-sm border border-emerald-800">
            <span className="text-xs font-medium text-emerald-400">Premium PC Components • Free Shipping</span>
          </div>
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            High-quality components for gamers, creators, and professionals. Custom builds with premium performance and unmatched aesthetics.
          </p>
